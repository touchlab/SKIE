...
@class SharedFlowAdapter<T>, SharedViewModel, SharedCallbackViewModel, SharedBreedRepository, SharedKermitLogger, SharedBreed, SharedBreedViewModel, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKotlinThrowable, SharedKoin_coreKoin, SharedKotlinDependencies, SharedBreedCallbackViewModel, SharedKaMPKitDbCompanion, SharedRuntimeQuery<__covariant RowType>, SharedBreedResult, SharedDatabaseHelper, SharedBreedRepositoryCompanion, SharedBreedViewStateEmpty, SharedBreedViewStateLoading, SharedBreedResultCompanion, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreModule, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKoin_coreKoinApplication, NSUserDefaults, SharedKermitLoggerCompanion, SharedKermitSeverity, SharedRuntimeTransacterTransaction, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreHttpClient, SharedKtor_client_coreHttpClientEngineConfig, SharedKotlinx_datetimeInstant, SharedKotlinCancellationException, SharedKoin_coreParametersHolderCompanion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreLevel, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreKoinApplicationCompanion, SharedKermitLogWriter, SharedKotlinByteArray, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKtor_httpUrl, SharedKtor_httpHttpMethod, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpStatusCode, SharedKtor_utilsGMTDate, SharedKtor_httpHttpProtocolVersion, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_eventsEvents, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKtor_client_coreProxyConfig, SharedKotlinx_datetimeInstantCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKotlinByteIterator, SharedKtor_httpUrlCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpHttpMethodCompanion, SharedKtor_utilsAttributeKey<T>, SharedKtor_httpContentType, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_eventsEventDefinition<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpResponse, SharedKotlinUnit, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpSendPipelinePhases, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKtor_utilsTypeInfo, SharedKtor_client_coreHttpClientCallCompanion, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKtor_ioMemory, SharedKtor_ioChunkBuffer, SharedKtor_ioBuffer, SharedKtor_ioByteReadPacket, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_httpURLBuilderCompanion, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioChunkBufferCompanion, SharedKtor_ioInputCompanion, SharedKtor_ioInput, SharedKtor_ioByteReadPacketCompanion, SharedKotlinKTypeProjection, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion;

@protocol SharedKotlinx_coroutines_coreFlow, SharedBreedViewState, SharedRuntimeSqlDriver, SharedKotlinx_coroutines_coreCoroutineScope, SharedCanceller, SharedKoin_coreKoinComponent, SharedTableQueries, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedKaMPKitDb, SharedRuntimeSqlDriverSchema, SharedDogApi, SharedKtor_client_coreHttpClientEngine, SharedMultiplatform_settingsSettings, SharedKotlinx_datetimeClock, SharedKotlinx_coroutines_coreJob, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_serialization_coreKSerializer, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedAppInfo, SharedKotlinx_coroutines_coreCoroutineExceptionHandler, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreFlowCollector, SharedKermitLoggerConfig, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedKotlinCoroutineContextKey, SharedKotlinCoroutineContextElement, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedRuntimeTransactionCallbacks, SharedRuntimeQueryListener, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_ioCloseable, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKoin_coreScopeCallback, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinComparable, SharedKotlinIterator, SharedKtor_httpHeaders, SharedKtor_utilsAttributes, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKtor_httpParameters, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKtor_client_coreHttpClientPlugin, SharedKotlinSuspendFunction2, SharedKotlinFunction, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKtor_httpHttpMessage, SharedKtor_ioByteReadChannel, SharedKtor_httpHttpMessageBuilder, SharedKtor_client_coreHttpRequest, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKotlinKType, SharedKtor_ioObjectPool;
...
__attribute__((swift_name("CallbackViewModel")))
@interface SharedCallbackViewModel : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)clear __attribute__((swift_name("clear()")));
- (SharedFlowAdapter<id> *)asCallbacks:(id<SharedKotlinx_coroutines_coreFlow>)receiver __attribute__((swift_name("asCallbacks(_:)")));
@property (readonly) SharedViewModel *viewModel __attribute__((swift_name("viewModel")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedCallbackViewModel")))
@interface SharedBreedCallbackViewModel : SharedCallbackViewModel
- (instancetype)initWithBreedRepository:(SharedBreedRepository *)breedRepository log:(SharedKermitLogger *)log __attribute__((swift_name("init(breedRepository:log:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)refreshBreeds __attribute__((swift_name("refreshBreeds()")));
- (void)updateBreedFavoriteBreed:(SharedBreed *)breed __attribute__((swift_name("updateBreedFavorite(breed:)")));
@property (readonly) SharedFlowAdapter<id<SharedBreedViewState>> *breeds __attribute__((swift_name("breeds")));
@property (readonly) SharedBreedViewModel *viewModel __attribute__((swift_name("viewModel")));
@end;
...
- (instancetype)initWithSqlDriver:(id<SharedRuntimeSqlDriver>)sqlDriver log:(SharedKermitLogger *)log backgroundDispatcher:(SharedKotlinx_coroutines_coreCoroutineDispatcher *)backgroundDispatcher __attribute__((swift_name("init(sqlDriver:log:backgroundDispatcher:)"))) __attribute__((objc_designated_initializer));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)insertBreedsBreeds:(NSArray<NSString *> *)breeds completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("insertBreeds(breeds:completionHandler:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)selectAllItems __attribute__((swift_name("selectAllItems()")));
- (id<SharedKotlinx_coroutines_coreFlow>)selectByIdId:(int64_t)id __attribute__((swift_name("selectById(id:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateFavoriteBreedId:(int64_t)breedId favorite:(BOOL)favorite completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("updateFavorite(breedId:favorite:completionHandler:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KotlinDependencies")))
@interface SharedKotlinDependencies : SharedBase <SharedKoin_coreKoinComponent>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)kotlinDependencies __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKotlinDependencies *shared __attribute__((swift_name("shared")));
- (SharedBreedCallbackViewModel *)getBreedViewModel __attribute__((swift_name("getBreedViewModel()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Breed")))
@interface SharedBreed : SharedBase
...
- (SharedBreed *)doCopyId:(int64_t)id name:(NSString *)name favorite:(BOOL)favorite __attribute__((swift_name("doCopy(id:name:favorite:)")));
...
__attribute__((swift_name("KaMPKitDb")))
@protocol SharedKaMPKitDb <SharedRuntimeTransacter>
@required
@property (readonly) id<SharedTableQueries> tableQueries __attribute__((swift_name("tableQueries")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KaMPKitDbCompanion")))
@interface SharedKaMPKitDbCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKaMPKitDbCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKaMPKitDb>)invokeDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("invoke(driver:)")));
@property (readonly) id<SharedRuntimeSqlDriverSchema> Schema __attribute__((swift_name("Schema")));
@end;

__attribute__((swift_name("TableQueries")))
@protocol SharedTableQueries <SharedRuntimeTransacter>
@required
- (void)deleteAll __attribute__((swift_name("deleteAll()")));
- (void)insertBreedName:(NSString *)name __attribute__((swift_name("insertBreed(name:)")));
- (SharedRuntimeQuery<SharedBreed *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(SharedLong *, NSString *, SharedBoolean *))mapper __attribute__((swift_name("selectAll(mapper:)")));
- (SharedRuntimeQuery<SharedBreed *> *)selectByIdId:(int64_t)id __attribute__((swift_name("selectById(id:)")));
- (SharedRuntimeQuery<id> *)selectByIdId:(int64_t)id mapper:(id (^)(SharedLong *, NSString *, SharedBoolean *))mapper __attribute__((swift_name("selectById(id:mapper:)")));
- (SharedRuntimeQuery<SharedBreed *> *)selectByNameName:(NSString *)name __attribute__((swift_name("selectByName(name:)")));
- (SharedRuntimeQuery<id> *)selectByNameName:(NSString *)name mapper:(id (^)(SharedLong *, NSString *, SharedBoolean *))mapper __attribute__((swift_name("selectByName(name:mapper:)")));
- (void)updateFavoriteFavorite:(BOOL)favorite id:(int64_t)id __attribute__((swift_name("updateFavorite(favorite:id:)")));
@end;

__attribute__((swift_name("DogApi")))
@protocol SharedDogApi
@required
...
@interface SharedDogApiImpl : SharedBase <SharedDogApi>
- (instancetype)initWithLog:(SharedKermitLogger *)log engine:(id<SharedKtor_client_coreHttpClientEngine>)engine __attribute__((swift_name("init(log:engine:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedRepository")))
@interface SharedBreedRepository : SharedBase
- (instancetype)initWithDbHelper:(SharedDatabaseHelper *)dbHelper settings:(id<SharedMultiplatform_settingsSettings>)settings dogApi:(id<SharedDogApi>)dogApi log:(SharedKermitLogger *)log clock:(id<SharedKotlinx_datetimeClock>)clock __attribute__((swift_name("init(dbHelper:settings:dogApi:log:clock:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedBreedRepositoryCompanion *companion __attribute__((swift_name("companion")));
- (id<SharedKotlinx_coroutines_coreFlow>)getBreeds __attribute__((swift_name("getBreeds()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateBreedFavoriteBreed:(SharedBreed *)breed completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("updateBreedFavorite(breed:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedRepository.Companion")))
@interface SharedBreedRepositoryCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBreedRepositoryCompanion *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedViewModel")))
@interface SharedBreedViewModel : SharedViewModel
- (instancetype)initWithBreedRepository:(SharedBreedRepository *)breedRepository log:(SharedKermitLogger *)log __attribute__((swift_name("init(breedRepository:log:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)onCleared __attribute__((swift_name("onCleared()")));
- (id<SharedKotlinx_coroutines_coreJob>)refreshBreeds __attribute__((swift_name("refreshBreeds()")));
- (id<SharedKotlinx_coroutines_coreJob>)updateBreedFavoriteBreed:(SharedBreed *)breed __attribute__((swift_name("updateBreedFavorite(breed:)")));
@property (readonly) id<SharedKotlinx_coroutines_coreStateFlow> breedState __attribute__((swift_name("breedState")));
@end;

__attribute__((swift_name("BreedViewState")))
@protocol SharedBreedViewState
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedViewStateData")))
@interface SharedBreedViewStateData : SharedBase <SharedBreedViewState>
- (instancetype)initWithBreeds:(NSArray<SharedBreed *> *)breeds __attribute__((swift_name("init(breeds:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<SharedBreed *> *breeds __attribute__((swift_name("breeds")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedViewStateEmpty")))
@interface SharedBreedViewStateEmpty : SharedBase <SharedBreedViewState>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)empty __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBreedViewStateEmpty *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedViewStateError")))
@interface SharedBreedViewStateError : SharedBase <SharedBreedViewState>
- (instancetype)initWithMessage:(NSString *)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *message __attribute__((swift_name("message")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BreedViewStateLoading")))
@interface SharedBreedViewStateLoading : SharedBase <SharedBreedViewState>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)loading __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBreedViewStateLoading *shared __attribute__((swift_name("shared")));
@end;
...
@property (class, readonly, getter=companion) SharedBreedResultCompanion *companion __attribute__((swift_name("companion")));
- (NSDictionary<NSString *, NSArray<NSString *> *> *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBreedResultCompanion *shared __attribute__((swift_name("shared")));
...
- (SharedKermitLogger *)loggerWithTagTag:(NSString *)tag __attribute__((swift_name("loggerWithTag(tag:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KoinIOSKt")))
@interface SharedKoinIOSKt : SharedBase
+ (SharedKoin_coreKoinApplication *)doInitKoinIosUserDefaults:(NSUserDefaults *)userDefaults appInfo:(id<SharedAppInfo>)appInfo doOnStartup:(void (^)(void))doOnStartup __attribute__((swift_name("doInitKoinIos(userDefaults:appInfo:doOnStartup:)")));
...
+ (id<SharedKotlinLazy>)injectLogger:(id<SharedKoin_coreKoinComponent>)receiver tag:(NSString *)tag __attribute__((swift_name("injectLogger(_:tag:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KermitExceptionHandlerKt")))
@interface SharedKermitExceptionHandlerKt : SharedBase
+ (id<SharedKotlinx_coroutines_coreCoroutineExceptionHandler>)kermitExceptionHandlerLog:(SharedKermitLogger *)log __attribute__((swift_name("kermitExceptionHandler(log:)")));
@end;
...
- (instancetype)initWithConfig:(id<SharedKermitLoggerConfig>)config tag:(NSString *)tag __attribute__((swift_name("init(config:tag:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedKermitLoggerCompanion *companion __attribute__((swift_name("companion")));
...
- (void)aMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("a(message:throwable:)")));
- (void)aThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("a(throwable:message:)")));
...
- (void)dMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("d(message:throwable:)")));
- (void)dThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("d(throwable:message:)")));
...
- (void)eMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("e(message:throwable:)")));
- (void)eThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("e(throwable:message:)")));
...
- (void)iMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("i(message:throwable:)")));
- (void)iThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("i(throwable:message:)")));
- (void)logSeverity:(SharedKermitSeverity *)severity tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable message:(NSString *)message __attribute__((swift_name("log(severity:tag:throwable:message:)")));
...
- (void)vMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("v(message:throwable:)")));
- (void)vThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("v(throwable:message:)")));
...
- (void)wMessage:(NSString *)message throwable:(SharedKotlinThrowable *)throwable __attribute__((swift_name("w(message:throwable:)")));
- (void)wThrowable:(SharedKotlinThrowable *)throwable message:(NSString *(^)(void))message __attribute__((swift_name("w(throwable:message:)")));
- (SharedKermitLogger *)withTagTag:(NSString *)tag __attribute__((swift_name("withTag(tag:)")));
@property (readonly) id<SharedKermitLoggerConfig> config __attribute__((swift_name("config")));
...
@protocol SharedKermitLoggerConfig
@required
@property (readonly) NSArray<SharedKermitLogWriter *> *logWriterList __attribute__((swift_name("logWriterList")));
@property (readonly) SharedKermitSeverity *minSeverity __attribute__((swift_name("minSeverity")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KermitLogger.Companion")))
@interface SharedKermitLoggerCompanion : SharedKermitLogger
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithConfig:(id<SharedKermitLoggerConfig>)config tag:(NSString *)tag __attribute__((swift_name("init(config:tag:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKermitLoggerCompanion *shared __attribute__((swift_name("shared")));
- (void)addLogWriterLogWriter:(SharedKotlinArray<SharedKermitLogWriter *> *)logWriter __attribute__((swift_name("addLogWriter(logWriter:)")));
- (void)setLogWritersLogWriter:(SharedKotlinArray<SharedKermitLogWriter *> *)logWriter __attribute__((swift_name("setLogWriters(logWriter:)")));
- (void)setLogWritersLogWriters:(NSArray<SharedKermitLogWriter *> *)logWriters __attribute__((swift_name("setLogWriters(logWriters:)")));
- (void)setMinSeveritySeverity:(SharedKermitSeverity *)severity __attribute__((swift_name("setMinSeverity(severity:)")));
...
@interface SharedKermitLogWriter : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)aMessage:(NSString *)message tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable __attribute__((swift_name("a(message:tag:throwable:)")));
