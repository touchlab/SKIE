...
abstract class GenerateVersionedSmokeTestsCIActionsTask : DefaultTask() {
    ...
    fun execute() {
        ...
        supportedVersions.get().forEach {
            ...
            val workflow = getSmokeTestsWorkflow(it, numberOfLibraryTests)

            outputPath.resolve("smoke-tests-${it.safeName}.yml").writeText(workflow)
        }
    }

    private fun getSmokeTestsWorkflow(version: SupportedKotlinVersion, numberOfLibraryTests: Int): String {
        ...
        return $$"""
            ...
            (0..(numberOfLibraryTests / libraryTestsBatchSize)).joinToString(System.lineSeparator()) {
                getExternalLibrariesJob(it, versionWithCompilerVersion, numberOfLibraryTests).prependIndent("  ")
            } + "\n"
    }
