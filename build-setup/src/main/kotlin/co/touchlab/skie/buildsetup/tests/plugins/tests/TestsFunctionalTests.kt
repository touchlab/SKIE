...
abstract class TestsFunctionalTests : Plugin<Project> {
    ...
    private fun Project.configureDependencies(primaryKotlinVersion: KotlinToolingVersion): Pair<Configuration, Configuration> {
        val exportedTestDependencies = maybeCreateTestDependencyConfiguration("functionalTestExportedDependencies").apply {
            isTransitive = false
        }

        val testDependencies = maybeCreateTestDependencyConfiguration("functionalTestDependencies").apply {
