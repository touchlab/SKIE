...
internal class SkieProduceObjCExportInterfaceInterceptor : PhaseInterceptor<PsiToIrContext, ObjCExportedInterface, ObjCExportCodeSpec> {
    ...
    override fun intercept(
        ...
        val declarationBuilder = SkieCompilerConfigurationKey.DeclarationBuilder.getOrNull(context.config.configuration)
        declarationBuilder?.declareSymbols(context.symbolTable!!)
