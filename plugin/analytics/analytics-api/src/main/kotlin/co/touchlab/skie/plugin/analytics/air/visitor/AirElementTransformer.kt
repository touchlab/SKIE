...
interface AirElementTransformer<in D> : AirElementVisitor<AirElement, D> {
    ...
    override fun visitDeclaration(declaration: AirDeclaration, data: D): AirDeclaration =
        throwNotImplemented()

    override fun visitValueParameter(valueParameter: AirValueParameter, data: D): AirValueParameter =
        valueParameter.copy(
    ...
    override fun visitTypeParameter(typeParameter: AirTypeParameter, data: D): AirTypeParameter =
        typeParameter.copy(
            annotations = typeParameter.annotations.map { it.transform(this, data) },
        )

    override fun visitAnonymousInitializer(anonymousInitializer: AirAnonymousInitializer, data: D): AirAnonymousInitializer =
    ...
    override fun visitConstructor(constructor: AirConstructor, data: D): AirConstructor =
        constructor.copy(
    ...
    @Suppress("DuplicatedCode")
    override fun visitSimpleFunction(simpleFunction: AirSimpleFunction, data: D): AirSimpleFunction =
        simpleFunction.copy(
    ...
    override fun visitConstantArray(constantArray: AirConstantArray, data: D): AirConstantArray =
        constantArray.copy(
            elements = constantArray.elements.map { it.transform(this, data) },
        )

    override fun visitConstantClassReference(constantClassReference: AirConstantClassReference, data: D): AirConstantClassReference =
        constantClassReference

    override fun visitConstantEnumReference(constantEnumReference: AirConstantEnumReference, data: D): AirConstantEnumReference =
        constantEnumReference

    override fun visitConstantErased(constantErased: AirConstantErased, data: D): AirConstantErased =
        constantErased

    override fun visitConstantObject(constantObject: AirConstantObject, data: D): AirConstantObject =
        constantObject.copy(
            valueArguments = constantObject.valueArguments.map { it.transform(this, data) },
        )

    override fun visitConstantPrimitive(constantPrimitive: AirConstantPrimitive, data: D): AirConstantPrimitive =
        constantPrimitive
