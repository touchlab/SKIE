...
internal class DefaultMutableSwiftScope(
            ...
            return when (bridge) {
                ...
                ReferenceBridge -> with(StandardNames.FqNames) {
                    when (val fqName = constructor.declarationDescriptor?.fqNameUnsafe) {
                        ...
                        uLongArrayFqName.toUnsafe() -> NativeKotlinType.Any
    ...
    fun NativeKotlinType.exactSpec(usage: KotlinTypeSpecUsage): TypeName? {
        ...
        return when (this) {
            is NativeKotlinType.Nullable -> when (usage) {
                ...
                KotlinTypeSpecUsage.TypeParam.AllowingNullability -> type.spec(KotlinTypeSpecUsage.TypeParam.OptionalWrapped).makeOptional()
            ...
            is NativeKotlinType.BlockPointer -> {
                ...
                when (usage) {
                    ...
                    KotlinTypeSpecUsage.ReturnType -> lambdaType
    ...
    private fun DeclaredTypeName.withTypeParametersOf(type: KotlinType, usageProvider: (index: Int, argument: TypeProjection) -> KotlinTypeSpecUsage): TypeName =
