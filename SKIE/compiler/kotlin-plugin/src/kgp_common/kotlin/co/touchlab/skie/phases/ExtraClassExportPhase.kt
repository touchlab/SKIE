...
internal class ExtraClassExportPhase(
    ...
    private fun MutableSet<ClassDescriptor>.addClassesForExportFromFlowArguments() {
        if (SkieConfigurationFlag.Feature_CoroutinesInterop !in skieContext.skieConfiguration.enabledConfigurationFlags) {
            return
        }
    ...
    private fun FunctionDescriptor.removeFromSwift() {
        skieContext.module.configure {
            this.swiftModel.visibility = co.touchlab.skie.swiftmodel.SwiftModelVisibility.Removed
        }
    }
}
