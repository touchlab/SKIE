...
package co.touchlab.skie.analytics.compiler
...
class CompilerAnalyticsProducer(
    ...
    private fun getFullCompilerAnalytics(): CompilerConfigurationDump =
        CompilerConfigurationDump(
    ...
    private fun CompilerConfiguration.getCommonConfig(): CompilerConfigurationDump.CommonConfig =
        CompilerConfigurationDump.CommonConfig(
            ...
            useLightTree = null,//get(CommonConfigurationKeys.USE_LIGHT_TREE),
    ...
    private fun CompilerConfiguration.getBinaryConfig(): CompilerConfigurationDump.BinaryConfig =
        CompilerConfigurationDump.BinaryConfig(
            ...
            objcExportDisableSwiftMemberNameMangling = null, //get(BinaryOptions.objcExportDisableSwiftMemberNameMangling),
            ...
            mimallocUseCompaction = null,// get(BinaryOptions.mimallocUseCompaction),
            preview19LLVMPipeline = null,//get(BinaryOptions.preview19LLVMPipeline),
        )
