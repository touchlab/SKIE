...
fun String.isLowerVersionThan(other: String): Boolean = isLowerVersionThan(this.split("."), other.split("."))

private fun isLowerVersionThan(lhs: List<String>, rhs: List<String>): Boolean = when {
