...
import co.touchlab.skie.kir.irbuilder.impl.symboltable.getIrTypeParameterPublicSymbolImpl
...
private fun SkieSymbolTable.declarePrivateTypeParameterAsPublic(typeParameter: IrTypeParameter) {
    ...
    val publicSymbol = getIrTypeParameterPublicSymbolImpl(signature, typeParameter.descriptor)
