...
abstract class Reflector {
    ...
    protected inline fun <reified R> declaredMethod0() = Provider { DeclaredMethod0(it, R::class.java) }

    protected inline fun <reified P1, reified R> declaredMethod1() = Provider {
        DeclaredMethod1(it, P1::class.java, R::class.java)
    }

    protected inline fun <reified P1, reified P2, reified R> declaredMethod2() = Provider {
        DeclaredMethod2(it, P1::class.java, P2::class.java, R::class.java)
    }

    protected inline fun <reified P1, reified P2, reified P3, reified R> declaredMethod3() = Provider {
        DeclaredMethod3(it, P1::class.java, P2::class.java, P3::class.java, R::class.java)
    }

    protected inline fun <reified P1, reified R : Reflector> reflectedDeclaredMethod1() = Provider {
    ...
    protected inline fun <reified T> declaredProperty() = Provider { DeclaredProperty(it, T::class.java) }
    ...
    protected abstract inner class DeclaredMethod<T, R>(name: String, private val returnType: Class<R>, parameterTypes: Array<Class<*>>) :
        ...
        protected fun invoke(arguments: Array<Any?>): R = method.invoke(instance, *arguments).let { returnType.cast(it) }
    }

    protected inner class DeclaredMethod0<R>(name: String, returnType: Class<R>) :
    ...
    protected inner class DeclaredMethod1<P1, R>(name: String, param1: Class<P1>, returnType: Class<R>) :
    ...
    protected inner class DeclaredMethod2<P1, P2, R>(name: String, param1: Class<P1>, param2: Class<P2>, returnType: Class<R>) :
    ...
    protected inner class ReflectedMethod<WRAPPED, T>(
        ...
        override fun getValue(thisRef: Reflector, property: KProperty<*>): T = method.getValue(thisRef, property).let(reflectorFactory)
    }
    ...
    protected inner class DeclaredProperty<T>(name: String, type: Class<T>) : ReadWriteProperty<Reflector, T> {
        ...
        override fun getValue(thisRef: Reflector, property: KProperty<*>): T = getter.getValue(thisRef, property).invoke()
    ...
    protected inner class DeclaredField<T>(name: String, private val type: Class<T>) : ReadWriteProperty<Reflector, T> {
        ...
        override fun getValue(thisRef: Reflector, property: KProperty<*>): T = field.get(instance).let { type.cast(it) }
    ...
    protected abstract inner class ExtensionFunction<T, R>(
        ...
        protected operator fun invoke(arguments: Array<Any?>): R = method.invoke(null, *arguments).let { returnType.cast(it) }
    }

    protected inner class ExtensionFunction0<R>(name: String, extensionClassFqName: String, returnType: Class<R>) :
    ...
    protected inner class ExtensionFunction1<P1, R>(name: String, extensionClassFqName: String, param1: Class<P1>, returnType: Class<R>) :
    ...
    protected inner class ExtensionProperty<T>(name: String, extensionClassFqName: String, type: Class<T>) :
