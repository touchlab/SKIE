...
class TopLevelFunctionDefaultArgumentGeneratorDelegate(context: FrontendIrPhase.Context, sharedCounter: SharedCounter) :
    BaseFunctionDefaultArgumentGeneratorDelegate(context, sharedCounter) {

    override fun DescriptorProvider.allSupportedFunctions(): List<SimpleFunctionDescriptor> = this.exposedTopLevelMembers
