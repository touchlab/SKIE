...
actual fun KonanConfig.getSpecificCompilerConfigurationAnalytics(): String = AnalyticsData(
...
@Serializable
private data class AnalyticsData(val objcExportDisableSwiftMemberNameMangling: Boolean?, val garbageCollector: String?)
