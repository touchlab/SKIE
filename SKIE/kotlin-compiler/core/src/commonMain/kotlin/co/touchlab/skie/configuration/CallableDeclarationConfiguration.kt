...
abstract class CallableDeclarationConfiguration(parent: FileOrClassConfiguration) : SkieConfiguration(parent.configuration) {
    ...
    ): VALUE where KEY : ConfigurationKey<VALUE>, KEY : ConfigurationScope.CallableDeclaration = getUnsafe(configurationKey)

    @JvmName("setCallableDeclaration")
    operator fun <KEY, VALUE> set(
        configurationKey: KEY,
        value: VALUE,
    ) where KEY : ConfigurationKey<VALUE>, KEY : ConfigurationScope.CallableDeclaration {
