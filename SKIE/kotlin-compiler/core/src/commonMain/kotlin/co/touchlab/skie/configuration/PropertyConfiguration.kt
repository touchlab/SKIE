...
class PropertyConfiguration(val parent: FileOrClassConfiguration) : CallableDeclarationConfiguration(parent) {
    ...
    operator fun <KEY, VALUE> set(
        ...
        value: VALUE,
    ) where KEY : ConfigurationKey<VALUE>, KEY : ConfigurationScope.Property {
