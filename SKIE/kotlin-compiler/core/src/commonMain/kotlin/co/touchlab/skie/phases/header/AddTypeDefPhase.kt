...
class AddTypeDefPhase(private val context: SirPhase.Context) : BaseHeaderInsertionPhase() {
...
private fun OirTypeDef.render(): String = "typedef ${type.render()} ${name}${visibility.attributeSuffixIfNeeded};"
