...
class SirHierarchyCache {
    ...
    private fun SirClass.isSelfOrInheritsFrom(other: SirClass): Boolean = other in this.getAllSuperTypesAndSelf()

    private fun SirClass.getAllSuperTypesAndSelf(): Set<SirClass> = allSuperTypesAndSelfCache.getOrPut(this) {
