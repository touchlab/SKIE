...
class FunctionSpec private constructor(builder: Builder) : AttributedSpec(builder.attributes.toImmutableList(), builder.tags) {
    ...
    internal fun emit(codeWriter: CodeWriter, enclosingName: String?, implicitModifiers: Set<Modifier>, conciseGetter: Boolean = false) {
    ...
    class Builder internal constructor(internal val name: String, internal val type: Type = Type.Function) :
        AttributedSpec.Builder<Builder>(),
        BuilderWithModifiers,
        BuilderWithTypeParameters,
