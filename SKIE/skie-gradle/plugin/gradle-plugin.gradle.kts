...
kotlin {
    sourceSets {
        val commonMain by getting {
            ...
            dependencies {
                implementation(projects.gradle.kotlinGradlePluginShim)

               // implementation("co.touchlab.skie:analytics")
               // implementation("co.touchlab.skie:configuration")
               // implementation("co.touchlab.skie:license")
               // implementation("co.touchlab.skie:util")
//
        ...
        tasks.named(target.artifactsTaskName) {
            kotlinToolingVersions.cells.forEach { kotlinVersion ->
                val shimConfiguration = configurations.detachedConfiguration(
                    projects.gradle.kotlinGradlePluginShim.kotlinGradlePluginShimImpl,
                ).apply {
                    attributes {
                        attribute(
