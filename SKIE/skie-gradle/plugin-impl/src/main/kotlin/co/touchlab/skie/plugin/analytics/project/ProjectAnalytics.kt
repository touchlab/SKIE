...
data class ProjectAnalytics(val projectId: String) {

    class Producer(private val rootProjectName: String, private val projectPath: String, private val projectGroup: Any) :
        AnalyticsProducer {
        ...
        override fun produce(): String = ProjectAnalytics(
