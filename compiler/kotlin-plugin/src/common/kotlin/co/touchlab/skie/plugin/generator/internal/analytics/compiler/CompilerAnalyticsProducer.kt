...
class CompilerAnalyticsProducer(private val context: CommonBackendContext) : AnalyticsProducer<AnalyticsFeature.Compiler> {
    ...
    private fun getFullCompilerAnalytics(): CompilerAnalytics {
        ...
        return with(context) {
            CompilerAnalytics(
                ...
                konanConfig = configuration.getKonanConfig(),
                binaryConfig = configuration.getBinaryConfig(),
    ...
    private fun KonanBackendContext.getMavenLibraries(): List<CompilerAnalytics.Library> {
    ...
    private fun Context.getCacheSupport(): CompilerAnalytics.CacheSupport =
