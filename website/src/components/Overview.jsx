      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-10 md:pt-16 md:pb-16 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-400">Kotlin Multiplatform generates libraries for iOS, but the interface is Objective-C, stripping your code of
