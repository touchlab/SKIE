...
The maximum number of default arguments can be explicitly configured using the `DefaultArgumentInterop.MaximumDefaultArgumentCount` key/annotation (see the [Configuration doc](/docs/Configuration.md), and specifically the [Local section](/docs/Configuration.md#local-via-kotlin-annontation).
