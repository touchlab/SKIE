...
@property (readonly) SharedFlowAdapter<SharedBreedViewState *> *breeds __attribute__((swift_name("breeds")));
...
@interface SharedBreedViewState : SharedBase
- (instancetype)initWithBreeds:(NSArray<SharedBreed *> * _Nullable)breeds error:(NSString * _Nullable)error isLoading:(BOOL)isLoading isEmpty:(BOOL)isEmpty __attribute__((swift_name("init(breeds:error:isLoading:isEmpty:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedBreed *> * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedBreedViewState *)doCopyBreeds:(NSArray<SharedBreed *> * _Nullable)breeds error:(NSString * _Nullable)error isLoading:(BOOL)isLoading isEmpty:(BOOL)isEmpty __attribute__((swift_name("doCopy(breeds:error:isLoading:isEmpty:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedBreed *> * _Nullable breeds __attribute__((swift_name("breeds")));
